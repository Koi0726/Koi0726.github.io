...
- [Nonlinear Topology Optimization of Viscoelastic Metamaterials for Prescribed Band Gaps]() (in script)
- [Multi-material Topology Optimization for Dynamic Thermo-Viscoelasticity]() (under review)
- [Multi-material dynamic topology optimization of reaction force minimization problem with viscoelasticity](https://doi.org/10.1016/j.finel.2026.104603)
...
- [Topology Optimization of Elastic and Viscoelastic Structures for Reaction Force Control and Energy Dissipation]()<br>**Guangwei Liu** (Advisor: Junji Kato)<br>
Supported by Japanese Government (MEXT) Scholarship.

- [Study on The Influence of Different Heat Process on Corrosion Behavior of the Ship Steel in Seawater]()<br>**Guangwei Liu** (Advisor: Caixiang Gu)<br>
Supported by SMU Postgraduate Academic Academic Merit ScholarshipScholarship.
